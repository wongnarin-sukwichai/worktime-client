                    ...
                    >
                        <ul class="flex items-center gap-2 text-sm font-medium">
                            ...
                            <li class="flex-1">
                                <router-link
                                    to="checkout"
                                    class="flex items-center justify-center gap-2 rounded-lg px-3 py-2  bg-orange-300 text-white hover:bg-orange-400 hover:shadow"
                                >
                                    ออกงาน</router-link
                                >
                            </li>
...
export default {
    ...
    methods: {
        async sendData() {
            ...
            try {
                await this.$store.dispatch("storeCheckout", this.record);
