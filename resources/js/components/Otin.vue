<template>
    <div class="p-16 shadow-inner bg-gradient-to-r from-blue-200 to-cyan-200">
                    ...
                    >
                        <ul class="flex items-center gap-2 text-sm font-medium">
                            ...
                            <li class="flex-1">
                                <router-link
                                    to="otin"
                                    class="flex items-center justify-center gap-2 rounded-lg px-3 py-2 text-white bg-sky-300 hover:bg-sky-400 hover:shadow"
                                >
